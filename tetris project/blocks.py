...
class LBlock(Block):
    def __init__(self):
        ...
        self.cells = {
            ...
            2: [Position(1, 2), Position (1, 1), Position (1, 2), Position(2, 0)], #Third rotation state
...
class ZBlock(Block):
    def __init__(self):
        ...
        self.cells = {
            ...
            2: [Position(1, 1), Position (1, 1), Position (2, 1), Position(2, 2)], #Third rotation state
            3: [Position(0, 0), Position (1, 0), Position (1, 1), Position(2, 0)]  #Fourth rotation state
        }
        self.move(0, 3)