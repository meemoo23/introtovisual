    ...
    def draw(self, screen):
        for row in range(self.num_rows):
            for column in range(self.num_cols):
                ...
                cell_rect = pygame.Rect(column*self.cell_size +11, row*self.cell_size +11, self.cell_size -1, self.cell_size -1) #esentially; x, y (coordinates), w (width), h (height) -- Rect is the cell (invisible). The +1 is used to create a margin for the cell blocks.
