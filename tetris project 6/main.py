...
score_rect = pygame.Rect(350, 60, 210, 60) #Score Rectangle
next_rect = pygame.Rect(350, 220, 210, 180)
...
while True:
    ...
    pygame.draw.rect(screen, Colors.darker_grey, score_rect, 0, 10)
    ...
    pygame.draw.rect(screen, Colors.darker_grey,next_rect, 0, 10)
    game.draw(screen)
