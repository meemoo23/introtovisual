...
class Game:
    def __init__(self):
        ...
        self.score = 0
        self.rotate_sound = pygame.mixer.Sound("rotatesound.mp3")
        self.clear_sound = pygame.mixer.Sound("lineclearsound.mp3")

        pygame.mixer.music.load("tetrismusic.mp3")
        pygame.mixer.music.play(-1) #Music should play on a loop
    ...
    def update_score(self, lines_cleared, move_down_points): #Simplified Scoring System; 
        if lines_cleared == 1:
            ...
            self.score += 300 #300 points for a double line cleared
    ...
    def draw(self, screen):
        ...
        if self.next_block.id == 3:
            self.next_block.draw(screen, 305, 320)
        elif self.next_block.id == 4:
            self.next_block.draw(screen, 305, 310)
        else:
            self.next_block.draw(screen, 320, 300)